...
function efectoHabilidades() {
    ...
    var distancia_habilidades = windows.innerHeight - habilidades.getBoundingClientRect().top;
    if (distancia_habilidades >= 300) {
        ...
        habilidades[7].classList.add("proyectos");
    }
}

//detecto el scrolling para aplicar animacion de la barra de habilidades
